function content_fill_empty_area() {
    // helper function to streamline the workflow of making extended art renders
    // this script rasterises the active layer and fills all empty pixels in the canvas on the layer with content-aware fill
